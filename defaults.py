...
_C.DATASET = CN()
_C.DATASET.PATH = os.path.join(os.getcwd(),'data\\datasets\\COVID\\tfrecords\\COVID-r%02d.tfrecords.%03d')
_C.DATASET.PATH_TEST =  os.path.join(os.getcwd(),'data\\datasets\\COVID\\tfrecords\\COVID_test-r%02d.tfrecords.%03d')
...
_C.DATASET.SAMPLES_PATH = 'no_path'

# _C.DATASET.STYLE_MIX_PATH = 'style_mixing\\test_images\\set_celeba\\'

_C.DATASET.MAX_RESOLUTION_LEVEL = 8

_C.MODEL = CN()

_C.MODEL.LAYER_COUNT = 7
...
_C.TRAIN.LOD_2_BATCH_1GPU = [512, 256, 256,   128,   64,    12]
...
_C.TRAIN.LEARNING_RATES = [0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002]
